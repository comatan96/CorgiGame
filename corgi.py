...
class Corgi:
    ...
    def draw_corgi_stand(self):
        ...
        pyxel.blt(x = self.location.x, y = self.location.y, img = 0, u = 0, v =0, w=11*direction, h =12, colkey=1)
    ...
    def corgi_run_right(self):
        ...
        if self.run_animation <= 25:
            pyxel.blt(x=location.x, y=location.y, img = 0, u = 0, v=16* (self.run_animation // 5), w=11*direction, h=12, colkey=0)#+16h
